    ...
    <section className="pageSection artworksPage">
      ...
      <div className="seriesList">
        {artworkSeries.map((series, index) => (
          <article
            className={`seriesBlock ${index % 2 !== 0 ? "seriesBlock--reverse" : ""}`}
            key={series.title}
          >
            ...
            <div className="seriesBlock__gallery">
              {series.images.map((image) => (
                <div className="seriesBlock__imageWrap" key={image.src}>
                  <img src={image.src} alt={image.alt} className="seriesBlock__image" />
                </div>
              ))}
            </div>
          </article>
